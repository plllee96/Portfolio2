...
HRESULT Reward::init(int stageNum) {
	switch (stageNum) {
		...
		case 3: _image = IMAGEMANAGER->addFrameImage(
			"Trophy", "Resources/Images/Objects/trophy.bmp", 49, 75, 1, 1, true, RGB(255, 0, 255)); break;
		case 4: _image = IMAGEMANAGER->addFrameImage(
			"Trophy2", "Resources/Images/Objects/trophy2.bmp", 54, 44, 1, 1, true, RGB(255, 0, 255)); break;
	}
